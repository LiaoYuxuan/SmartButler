package com.exemple.lenvo.smartbutler.activity;
...
import com.exemple.lenvo.smartbutler.model.MusicData;
import com.exemple.lenvo.smartbutler.service.MusicService;
import com.exemple.lenvo.smartbutler.utils.DisplayUtil;
import com.exemple.lenvo.smartbutler.utils.FastBlurUtil;
import com.exemple.lenvo.smartbutler.widget.BackgourndAnimationRelativeLayout;
import com.exemple.lenvo.smartbutler.widget.DiscView;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.exemple.lenvo.smartbutler.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;
import static com.exemple.lenvo.smartbutler.widget.DiscView.IPlayInfo;
import static com.exemple.lenvo.smartbutler.widget.DiscView.MusicChangedStatus;
...
public class MainActivity extends AppCompatActivity implements IPlayInfo, View
    ...
    private Toolbar mToolbar;                                       //Toolbar实现标题栏
   ...
   //有一个bug，按下返回键后音乐保留在上次播放的地方，而图像则初始化
    @Override
